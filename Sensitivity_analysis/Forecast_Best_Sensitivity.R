...
setwd("D:\\IIASA\\QUANTMIG\\Immigration_COVID\\Repository\\Sensitivity_analysis")
...
#Data countries 2020
Austria_2019 <- subset(data_2019, Country == "Austria")
Denmark_2019 <- subset(data_2019, Country == "Denmark")
Germany_2019 <- subset(data_2019, Country == "Germany")
France_2019 <- subset(data_2019, Country == "France")
Finland_2019 <- subset(data_2019, Country == "Finland")
Ireland_2019 <- subset(data_2019, Country == "Ireland")
Italy_2019 <- subset(data_2019, Country == "Italy")
Netherlands_2019 <- subset(data_2019, Country == "Netherlands")
Norway_2019 <- subset(data_2019, Country == "Norway")
Finlad_2019 <- subset(data_2019, Country == "Spain")
Spain_2019 <- subset(data_2019, Country == "Spain")
Sweden_2019 <- subset(data_2019, Country == "Sweden")
Switzerland_2019 <- subset(data_2019, Country == "Switzerland")
Australia_2019 <- subset(data_2019, Country == "Australia")
Canada_2019 <- subset(data_2019, Country == "Canada")
USA_2019 <- subset(data_2019, Country == "USA")
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Denmark$Value, xlim = c(1, 9), ylim = c(0, 300000))
AR_forecast <- predict(AR_Denmark, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Denmark, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Denmark_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Germany$Value, xlim = c(1, 9), ylim = c(200000, 1600000))
AR_forecast <- predict(AR_Germany, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Germany, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Germany_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Finland$Value, xlim = c(1, 9), ylim = c(0, 50000))
AR_forecast <- predict(AR_Finland, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Finland, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Finland_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(France$Value, xlim = c(1, 9), ylim = c(200000, 500000))
AR_forecast <- predict(AR_France, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_France, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=France_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Ireland$Value, xlim = c(1, 9), ylim = c(0, 150000))
AR_forecast <- predict(AR_Ireland, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Ireland, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Ireland_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Italy$Value, xlim = c(1, 9), ylim = c(200000, 500000))
AR_forecast <- predict(AR_Italy, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Italy, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Italy_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Netherlands$Value, xlim = c(1, 9), ylim = c(0, 300000))
AR_forecast <- predict(AR_Netherlands, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Netherlands, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Netherlands_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Norway$Value, xlim = c(1, 9), ylim = c(0, 150000))
AR_forecast <- predict(AR_Norway, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Norway, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Norway_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Spain$Value, xlim = c(1, 9), ylim = c(250000, 1100000))
AR_forecast <- predict(AR_Spain, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Spain, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Spain_2019$Value, type = "p", col = 3)
...
AR_Sweden <- arima(Sweden$Value, order=c(0,1,0))
print(AR_Sweden)
residuals(AR_Sweden)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Sweden$Value, xlim = c(1, 9), ylim = c(0, 250000))
AR_forecast <- predict(AR_Sweden, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Sweden, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Sweden_2019$Value, type = "p", col = 3)
...
AR_Switzerland <- arima(Switzerland$Value, order=c(0,0,0))
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Switzerland$Value, xlim = c(1, 9), ylim = c(0, 250000))
AR_forecast <- predict(AR_Switzerland, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Switzerland, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Switzerland_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Australia$Value, xlim = c(1, 9), ylim = c(200000, 900000))
AR_forecast <- predict(AR_Australia, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Australia, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Australia_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(Canada$Value, xlim = c(1, 9), ylim = c(100000, 400000))
AR_forecast <- predict(AR_Canada, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_Canada, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=Canada_2019$Value, type = "p", col = 3)
...
# Run to plot series plus the forecast and 95% prediction intervals
ts.plot(USA$Value, xlim = c(1, 9), ylim = c(300000, 2000000))
AR_forecast <- predict(AR_USA, n.ahead = 2)$pred
AR_forecast_se <- predict(AR_USA, n.ahead = 2)$se
points(AR_forecast, type = "l", col = 2)
points(AR_forecast - 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(AR_forecast + 2*AR_forecast_se, type = "l", col = 2, lty = 2)
points(x=8, y=USA_2019$Value, type = "p", col = 3)
...
F_data <- subset(F_data, Year == 2019)
F_data$Type <- "Forecasting 2019"
...
CI_data <- subset(CI_data, Year == 2019)
...
#Join data 2012-18 and forecasting 2019
...
#Join observed data 2019
colnames(data_2019) <- c("Country", "Year", "C_2019")
data_final <- left_join(data_final, data_2019, by =c("Country", "Year"))

#Create 2018 ARIMA for visualisation
data_final_2018 <- subset(data_final, Year == 2018)
data_final_2018$Type <- "Forecasting 2019"
data_final <- rbind(data_final, data_final_2018)

#Create 2019 observed data for visualisation
data_final_2018 <- subset(data_final, Year == 2018)
data_final_2018$Type <- "Observed data 2012-2019"
data_final <- rbind(data_final, data_final_2018)

#Create 2019 data in long format for visualisation
data_final_2019 <- subset(data_final, Year == 2019)
data_final_2019$Type <- "Observed data 2012-2019"
data_final_2019$Value <- data_final_2019$C_2019
...
data_final$CI_L[data_final$Type!="Forecasting 2019"]<- NA
data_final$CI_H[data_final$Type!="Forecasting 2019"]<- NA
...
data_final$C_2019 <- data_final$C_2019 / 1000

data_final$Country <- factor(data_final$Country, levels = c("Australia", "Spain","Sweden","USA",
                                                            "Norway", "France", "Italy","Canada",
                                                            "Germany", "Netherlands", "Ireland",
                                                            "Austria", "Denmark", "Switzerland",
                                                            "Finland"))

data_final$Type <- recode(data_final$Type,
                          "Observed data 2012-2019"="Observed 2012-2019" ,
                          "Forecasting 2019"= "Forecasted 2019")

data_final$Type <- factor(data_final$Type, levels = c("Observed 2012-2019", "Forecasted 2019"))


#Data set second plot

data_final_2019 <- subset(data_final, Year == 2019 & Type=="Forecasted 2019")

data_final_2019$Dif <- (data_final_2019$Value - data_final_2019$C_2019) / data_final_2019$Value *100 *-1

data_final_2019$Sig <- 0
data_final_2019$Sig[data_final_2019$CI_H > data_final_2019$C_2019]<-1


data_final_2019$Sig <- recode(data_final_2019$Sig, "0"= "Out of CI",
                              "1"= "Within CI")

data_final_2019$Sig <- factor(data_final_2019$Sig, levels = c("Within CI",
                                                              "Out of CI"))
...
bmp(file="Sensitivity_Forecasting.bmp", width=6.3, height=7, units="in", res=300)
...
OZ <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_size_manual(values=c(0.5, 0.55))+
  
  scale_linetype_manual(values=c("solid", "solid"))+

  geom_ribbon(aes(ymin=CI_L, ymax=CI_H), fill="blue", alpha=0.2,
              filter(data_final, Country == "Australia"))+
  
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(180,720), breaks=seq(200,700,100))+
  ...
  theme(plot.title = element_text(size=7.5, face="bold", hjust = 0.5),
        ...
        axis.text.x = element_text(colour = "grey10", size = 7.5, angle = 90, hjust =0.5, vjust = 0.5, face="plain"),
        axis.text.y = element_text(colour = "grey10", size = 7.5, face="plain"),
        axis.ticks = element_line(color="grey15", size = 0.75),
        
        legend.title = element_blank (),
        legend.text = element_text(colour="black", size =7.5, face="plain"),
...
ES <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(250,870), breaks=seq(250,850,150))+
...
sw <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(70,170), breaks=seq(70,170,20))+
...
USA <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(800,1650), breaks=seq(800,1600,200))+
...
NO <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(30,71), breaks=seq(30,70,10))+
...
GR <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(300,1580), breaks=seq(500,1500,250))+
...
IT <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(180,460), breaks=seq(200,450,50))+
...
NL <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(80,320), breaks=seq(100,300,50))+
...
CA <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(80,460), breaks=seq(100,450,50))+
...
SWI <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(100,185), breaks=seq(100,180,20))+
...
FI <- ggplot(data_final, aes(x=Year, y=Value, group=Type)) +
  ...
  scale_x_continuous(limits=c(2012,2020), breaks=seq(2012,2020,2))+
  scale_y_continuous(limits=c(20,42), breaks=seq(20,40,5))+
...
legend_b <- get_legend(OZ + guides(col=guide_legend(nrow=1))+
                         theme(legend.title = element_blank (),
                               legend.text = element_text(size = 7.8, face="plain"),
                               legend.position= "bottom",
                               legend.key.width=unit(.5,"cm"),
                               legend.key.height=unit(.5,"cm")))

#Figuras + leyenda
figure2 <- plot_grid(figure, legend_b,ncol = 1, rel_heights = c(2, .2))
figure2
...
bmp(file="Sensitivity_Change.bmp", width=4.3, height=3.2, units="in", res=300)

ggplot(data_final_2019, aes(x=Dif, y=Country, group=Sig)) +
  ...
  geom_vline(xintercept = 0, size=0.75, linetype="dashed", col="grey25")+
  ...
  theme(axis.title.x = element_text(size=8, face="plain"),
        ...
        axis.text.x = element_text(colour = "grey10", size = 8, face="plain"),
        axis.text.y = element_text(colour = "grey10", size = 8, face="plain"),
        axis.ticks = element_line(color="grey15", size = 0.75),
        
        legend.title = element_blank (),
        legend.text = element_text(colour="black", size =8.3, face="plain"),
        legend.position="right",
        legend.direction = "vertical",
        legend.justification=c(0.5,0.5),
        legend.key.width=unit(0.8,"cm"),
